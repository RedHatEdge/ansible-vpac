...
- `pcs cluster setup <cluster_name> <node>=<heartbeat_ip> ...` — Corosync binds to the **dedicated heartbeat network** only, never to the VM-mgmt bridge (see LEARNED-FIXES: field deployment April 15 split-brain)
